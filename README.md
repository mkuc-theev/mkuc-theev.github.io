...
2. <img width="80" height="auto" alt="image" src="https://github.com/user-attachments/assets/2cfef3ab-5229-48b2-b99d-ad234130c5ce" />
...
4. Create your minecraft instance:
...
5. After the instance is created, let's add the rest of the mods.
   ...
   - The mods will be "auto"matically installed and you can click "Close" on the remaining window. Your game is now ready to go.
